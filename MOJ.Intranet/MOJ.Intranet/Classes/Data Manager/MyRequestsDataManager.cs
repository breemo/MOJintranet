                    ...
                    using (SPWeb oWeb = oSite.RootWeb)
                    {
                        if (oWeb != null)
                        {
                            ...
                            if (lst != null)
                            {
                                ...
                                string camlquery1 = "<Where><Eq><FieldRef Name='RequestBy' LookupId='TRUE' /><Value Type='User'>"+ SPContext.Current.Web.CurrentUser.ID + "</Value> </Eq></Eq></Where><OrderBy><FieldRef Name='ID' Ascending='false' /></OrderBy>";
