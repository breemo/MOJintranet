...
namespace MOJ.Intranet.Webparts.Inner_Pages.FilesWP
{
    public partial class FilesWPUserControl : UserControl
    {
                    ...
                    lblDrawItems.Text +=
                                      string.Format(@"
                                            <div class='col-md-2 col-sm-4'>
                                                ...
                                                <div class='filuo'>
                                                    <a href='" + siteURL + @"/"+ SPUtility.GetLocalizedString("$Resources: DocumentsFilesPath", "Resource", SPContext.Current.Web.Language) + "/" + item.Title + @"'>
                                                    <div class='" + classname + @"'>
                                                        <p>
