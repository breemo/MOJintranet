...
<div class="headlineflex">
    ...
    <a href="<%= SPContext.Current.RootFolderUrl %>/Occasions.aspx" class="slide morebuttoncss arrow"><asp:Literal runat="server" Text="<%$ Resources:Resource, MoreOccasions%>" /></a>
</div>
