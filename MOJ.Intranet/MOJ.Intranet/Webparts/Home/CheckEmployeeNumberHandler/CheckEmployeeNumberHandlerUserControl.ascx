...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckEmployeeNumberHandlerUserControl.ascx.cs" Inherits="MOJ.Intranet.Webparts.Home.CheckEmployeeNumberHandler.CheckEmployeeNumberHandlerUserControl" %>
