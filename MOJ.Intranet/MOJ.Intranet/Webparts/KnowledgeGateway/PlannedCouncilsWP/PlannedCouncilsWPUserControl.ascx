...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PlannedCouncilsWPUserControl.ascx.cs" Inherits="MOJ.Intranet.Webparts.KnowledgeGateway.PlannedCouncilsWP.PlannedCouncilsWPUserControl" %>
