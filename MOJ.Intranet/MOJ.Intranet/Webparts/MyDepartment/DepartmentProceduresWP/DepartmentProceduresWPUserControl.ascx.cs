                ...
                foreach (DepartmentProceduresEntity item in DepartmentProceduresLst)
                {
                    ...
                    lblDrawItems.Text +=
                        ...
                        <div class='enteyitemnew'>
                            ...
                            <a href = '{3}/Pages/Details.aspx?Sid={4}&type=Procedures' class='detailbtn'>" + SPUtility.GetLocalizedString("$Resources: ReadMore", "Resource", SPContext.Current.Web.Language) + @"</a>
