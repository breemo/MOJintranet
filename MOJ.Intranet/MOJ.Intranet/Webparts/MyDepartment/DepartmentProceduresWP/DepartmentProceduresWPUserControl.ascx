...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DepartmentProceduresWPUserControl.ascx.cs" Inherits="MOJ.Intranet.Webparts.MyDepartment.DepartmentProceduresWP.DepartmentProceduresWPUserControl" %>

<div class="insidebox">
    <h4 class="ta3m"> <asp:Literal runat="server" Text="<%$ Resources:Resource, DepartmentProceduresTitle%>" /></h4>
    ...
    <div class="boxscroll demo-rtl os-host os-theme-dark os-host-overflow os-host-overflow-y os-host-rtl os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition" data-simplebar="init" data-simplebar-auto-hide="false">
        ...
        <div class="os-scrollbar os-scrollbar-vertical">
            <div class="os-scrollbar-track">
                <div class="os-scrollbar-handle" style="height: 63.6364%; transform: translate(0px, 101px);"></div>
            </div>
        </div>
